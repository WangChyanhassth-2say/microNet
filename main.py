...
parser.add_argument('-a', '--arch', metavar='ARCH', default='m0',
                    help='model architecture', choices = ['m0','m1','m2','m3'])
...
def main():
   ...
   # print('done')
    ...
    title = 'ImageNet - MicroNet_' + args.arch
    ...
    if os.path.exists(os.path.join('micronet/checkpoints', args.checkpoint.split('/')[-1], 'checkpoint.pth')):
        args.resume = os.path.join('micronet/checkpoints', args.checkpoint.split('/')[-1], 'checkpoint.pth')
