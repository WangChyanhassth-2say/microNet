...
export OUTPUT_PATH=$2/m1_eval
export WEIGHT_PATH=$3

CUDA_VISIBLE_DEVICES=0,1,2,3 python -W ignore main.py --arch MicroNet -d $DATA_PATH -c $OUTPUT_PATH -j 48 --input-size 224 -b 512 -e --weight $WEIGHT_PATH \
