...
def get_pytorch_train_loader(data_path, batch_size, workers=0, _worker_init_fn=None, input_size=224):
...
def get_pytorch_val_loader(data_path, batch_size, workers=0, _worker_init_fn=None, input_size=224):
